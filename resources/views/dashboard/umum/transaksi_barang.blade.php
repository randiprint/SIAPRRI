<div class="container-fluid py-4 px-4">
    ...
    <div class="row justify-content-center" style="font-size: 10pt">
        <div class="col-md-12 ">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $transaksi->lokasi ?? '-' }}</td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    {{ $transaksi->status_pegawai ?? '-' }}
                                                    <hr>
                                                    <strong>Keterangan:</strong><br>
                                                    {{ $transaksi->alasan }}
                                                    <hr>
                                                    <strong>Kategori:</strong><br>
                                                    {{ $transaksi->barang->jenisBarangPersediaan ?? '-' }}
                                                    <hr>
